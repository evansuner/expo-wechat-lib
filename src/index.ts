...
const assertRegistration = (name: string) => {
  if (!registered) {
...
export const sendAuthRequest = (
  ...
  assertRegistration("sendAuthRequest");
...
export const shareWebpage = (request: {
  ...
  assertRegistration("shareWebpage");
...
export const shareMiniProgram = (request: {
  ...
  assertRegistration("shareMiniProgram");
...
export const requestPayment = (request: {
  ...
  assertRegistration("requestPayment");
...
export const requestSubscribeMessage = (request: {
  ...
  assertRegistration("requestSubscribeMessage");
...
export const openCustomerService = (request: {
  ...
  assertRegistration("openCustomerService");
...
export const launchMiniProgram = (request: {
  ...
  assertRegistration("launchMiniProgram");
...
export const appPureSignContract = (request: {
  ...
  assertRegistration("appPureSignContract");
